  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center space-x-2">
        {isCardClosed ? (
          <Badge variant="outline" className="text-xs bg-red-100 text-red-700 border-red-300 dark:bg-red-900/30 dark:text-red-400 dark:border-red-700">
      ...
      <div className="w-full">
        <InlineEdit
          ...
          className="text-lg font-semibold text-foreground cursor-pointer hover:bg-muted/50 p-1 rounded transition-colors max-w-full break-words w-full"
